//---------------------------------------------------------------------------
#ifndef TMsgSolicitaRegistroH
#define TMsgSolicitaRegistroH
...
//---------------------------------------------------------------------------
class TMsgSolicitaRegistro : public VTMsg
   {
   public:
                 __fastcall  TMsgSolicitaRegistro(void);
                 __fastcall ~TMsgSolicitaRegistro(void);
