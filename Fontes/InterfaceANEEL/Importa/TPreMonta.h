...
class TPreMonta : public VTPreMonta
	...
	public:
		...
		virtual bool __fastcall  InsereCurvaTipicaBT(sdi_CURVA &sdi);
		virtual bool __fastcall  InsereCurvaTipicaMT(sdi_CURVA &sdi);
		virtual bool __fastcall  InsereGeradorBT(sdi_GERADOR_BT &sdi);
		virtual bool __fastcall  InsereGeradorMT(sdi_GERADOR_MT &sdi);
		virtual bool __fastcall  InsereRamalBT(sdi_RAMAL &sdi);
   ...
   protected: //métodos
		...
		bool          __fastcall MontaValoresCurva_pu_media(double *p_kw, int len_p_kw, double *p_pu, int len_p_pu);
