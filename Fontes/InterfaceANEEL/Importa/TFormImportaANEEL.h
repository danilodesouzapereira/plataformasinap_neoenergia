//---------------------------------------------------------------------------
#ifndef TFormImportaANEELH
#define TFormImportaANEELH
...
//---------------------------------------------------------------------------
class TFormImportaANEEL : public TForm
{
...
public:      // User declarations
   __fastcall  TFormImportaANEEL(TComponent* Owner, VTApl *apl);
	__fastcall ~TFormImportaANEEL(void);
