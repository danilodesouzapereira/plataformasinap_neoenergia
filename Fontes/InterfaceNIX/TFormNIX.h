...
public:		// User declarations
   __fastcall  TFormNIX(TComponent *Owner, VTApl *apl_owner, TWinControl *parent);
   __fastcall ~TFormNIX(void);
...
private:	//métodos
	...
	bool __fastcall PrimarioSemTrafoAberto(void);
