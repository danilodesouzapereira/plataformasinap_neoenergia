//---------------------------------------------------------------------------
#ifndef TMontaEstudoH
#define TMontaEstudoH
...
//---------------------------------------------------------------------------
class TMontaEstudo : public VTMonta
   {
   public:
                 __fastcall  TMontaEstudo(VTApl *apl);
                 __fastcall ~TMontaEstudo(void);
      ...
      void       __fastcall  ReiniciaLisBarraLocal(void);
   ...
   private: //métodos
      VTEqpto* __fastcall ExisteEqptoDaObra(int tipo_eqpto, int eqpto_id, bool remove);
      VTEqpto* __fastcall ExisteEqptoDaRede(int tipo_eqpto, int eqpto_id);
