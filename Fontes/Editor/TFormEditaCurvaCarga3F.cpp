...
// ---------------------------------------------------------------------------
__fastcall TFormEditaCurvaCarga3F::TFormEditaCurvaCarga3F(TComponent* Owner, TForm* form_owner, VTApl * apl_owner,
	TWinControl * parent) : TForm(Owner)
{
	...
	formEdtCar = (TFormEdtCar*) form_owner;
...
// ---------------------------------------------------------------------------
__fastcall TFormEditaCurvaCarga3F::~TFormEditaCurvaCarga3F(void)
{
...
// ---------------------------------------------------------------------------
void __fastcall TFormEditaCurvaCarga3F::CBoxNumPtoInicia(void)
{
...
// ---------------------------------------------------------------------------
void __fastcall TFormEditaCurvaCarga3F::CBoxNumPtoChange(TObject *Sender)
{
...
// ---------------------------------------------------------------------------
void __fastcall TFormEditaCurvaCarga3F::CBoxTipoCargaChange(TObject *Sender)
{
...
// ---------------------------------------------------------------------------
void __fastcall TFormEditaCurvaCarga3F::DefineCurva(VTEqpto *eqpto, VTCurva *curva)
{
...
// ---------------------------------------------------------------------------
void __fastcall TFormEditaCurvaCarga3F::ExibeDados(void)
{
	// variáveis locais
	VTPatamar *patamar;
	int col_fixa, dim;
...
// ---------------------------------------------------------------------------
void __fastcall TFormEditaCurvaCarga3F::FormShow(TObject *Sender)
{
	//nada
}

// ---------------------------------------------------------------------------
bool __fastcall TFormEditaCurvaCarga3F::LePontosCurva(void)
{
	// variáveis locais
	TFase *fase;

	// dados gerais
	fase = (TFase*)formEdtCar->CBoxFase->Items->Objects[formEdtCar->CBoxFase->ItemIndex];
	fase_tag = fase->tag;
...
// ---------------------------------------------------------------------------
bool __fastcall TFormEditaCurvaCarga3F::LeDadosPatamarFixo(void)
{
	// variáveis locais
	strHM hm_ini, hm_fim;
	VTPatamar *patamar;
...
// ---------------------------------------------------------------------------
bool __fastcall TFormEditaCurvaCarga3F::LeDadosPatamarVariavel(void)
{
	// variáveis locais
	strHM hm_ini, hm_fim;
	VTPatamar *patamar;
...
// ---------------------------------------------------------------------------
void __fastcall TFormEditaCurvaCarga3F::SGridInicia(void)
{
	// Variáveis locais
	...
	{
		fase_tag = 0;
		formEdtCar->CBoxFase->ItemIndex = 0;
	}
...
// ---------------------------------------------------------------------------
void __fastcall TFormEditaCurvaCarga3F::SGridIniciaPatamarFixo(void)
{
	// variáveis locais
	VTPatamar *patamar;
	VTFases *fases = (VTFases*)apl->GetObject(__classid(VTFases));
...
// ---------------------------------------------------------------------------
void __fastcall TFormEditaCurvaCarga3F::SGridIniciaPatamarVariavel(void)
{
	// variáveis locais
	VTFases *fases = (VTFases*)apl->GetObject(__classid(VTFases));
	VTPatamar *patamar;
...
// ---------------------------------------------------------------------------
bool __fastcall TFormEditaCurvaCarga3F::SGridExistePeriodo(int nr)
{
...
/*
// ---------------------------------------------------------------------------
void __fastcall TFormEditaCurvaCarga3F::TrataPorFaseParaTrifasico(void)
{
	//variaveis locais
	int max_valor = 6;
	double valor[nvCURVA_RRCAR];
...
void __fastcall TFormEditaCurvaCarga3F::TrataPorFaseParaTrifasico(void)
{
	...
	//passa eqpto e curva para conversor
	converte->DefineCurva(eqpto, curva);
	//converte
	curva_nova = converte->FaseToTrifasica();
	//copia pontos para curva
	curva->CopiaAtributosDe(*curva_nova);
}
/*
// ---------------------------------------------------------------------------
void __fastcall TFormEditaCurvaCarga3F::TrataTrifasicoParaPorFase(void)
{
	//variaveis locais
	VTFases *fases = (VTFases*)apl->GetObject(__classid(VTFases));
	//int max_valor = 6;
...
void __fastcall TFormEditaCurvaCarga3F::TrataTrifasicoParaPorFase(void)
{
	...
	converte->DefineCurva(eqpto, curva);
	//converte
	curva_nova = converte->TrifasicaToFase();
	//copia pontos para curva
	curva->CopiaAtributosDe(*curva_nova);
}
