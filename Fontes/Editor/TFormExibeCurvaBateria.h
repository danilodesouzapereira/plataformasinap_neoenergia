...
//---------------------------------------------------------------------------
class TFormExibeCurvaBateria : public TForm
{
...
public:		// User declarations
        __fastcall  TFormExibeCurvaBateria(TForm* form_owner, VTApl *apl_owner, TWinControl *parent);
        __fastcall ~TFormExibeCurvaBateria(void);
   ...
   void __fastcall  IniciaAbcissa(int atributo_id);
