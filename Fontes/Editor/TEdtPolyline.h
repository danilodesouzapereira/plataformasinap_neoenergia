...
//---------------------------------------------------------------------------
class TEdtPolyline : public TEdt
   {
   public:
            __fastcall  TEdtPolyline(VTApl *apl, TAction *ResetFocus, TAction *SetFocus, TAction *OnDone, TWinControl *parent);
            __fastcall ~TEdtPolyline(void);
