...
{
	return (new TBDeqptoAccess422(apl_owner, bd_conn));
}

// ---------------------------------------------------------------------------
__fastcall TBDeqptoAccess422::TBDeqptoAccess422(VTApl *apl_owner, VTSNPDBConn *bd_conn)
...
// ---------------------------------------------------------------------------
__fastcall TBDeqptoAccess422::~TBDeqptoAccess422(void)
{
	// nada a fazer
}

// ---------------------------------------------------------------------------
bool __fastcall TBDeqptoAccess422::SPSNP_rdBateria(VTEstudo* estudo, bool bolUseRedeTmp,
	bool bolObra)
{
	// a tabela nao existe
	return true;
...
// ---------------------------------------------------------------------------
bool __fastcall TBDeqptoAccess422::SPSNP_rdEstudo(void)
{//igual versao 410
	bool sucesso = true;
	AnsiString strlog;
	AnsiString strSQL;
...
// ---------------------------------------------------------------------------
bool __fastcall TBDeqptoAccess422::SPSNP_rdEstudoAlternativa(VTEstudo* estudo)
{//igual versao 40 (sem obra finalizada e bloqueada)
	bool sucesso = true;
	double tipo_padrao;
	AnsiString strlog;
	AnsiString strSQL;
...
// ---------------------------------------------------------------------------
bool __fastcall TBDeqptoAccess422::SPSNP_rdEstudoObraAtribExt(VTEstudo* estudo)
{ // igual versao 410
	bool sucesso = true;
	double tipo_padrao;
	AnsiString strlog;
...
// ---------------------------------------------------------------------------
bool __fastcall TBDeqptoAccess422::SPSNP_rdMunicipio(void)
{
	// a tabela nao existe
	return true;
}
...
// ---------------------------------------------------------------------------
bool __fastcall TBDeqptoAccess422::SPSNP_rdRegulador(VTEstudo* estudo, bool bolUseRedeTmp,
	bool bolObra)
{//campo tensao inversa, largura de banda, relação de tap
	bool sucesso = true;
	AnsiString strlog;
	AnsiString strSQL;
	TADOQuery* ptrQryDS = NULL;
