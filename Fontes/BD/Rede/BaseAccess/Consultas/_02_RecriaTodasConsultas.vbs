On Error Resume Next
    ...
    ' --- Iniciação dos paths  ---
    'strDirSpec    = "D:\Projetos\Sinap\Rev5.0\PlataformaSinap\Fontes\BDado\Consultas\Rede"
	' Alterado em 20141212 para rodar no Win8. Tem que executar o wscript.exe a partir do system32
    'strDirSpec = "."
    'strDirSpec = "Z:\Sinap\Rev4.0_XE\PlataformaSinap\Fontes\BD\Rede\BaseAccess\Consultas"
	strDirSpec = "Z:\SINAPgrid\PlataformaSinap\Fontes\BD\Rede\BaseAccess\Consultas"
    ...
    strDBFileName = strDBFilePath & "Rede_v425.mdb"
    ...
    DBConn.Open "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & strDBFileName & "; Jet OLEDB:Database Password=" & strPWd
