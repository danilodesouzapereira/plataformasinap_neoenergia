'    On Error Resume Next 
    ...
    For intCount = 0 To catTab.Tables.Count - 1
      ...
      If (straux = "TmpEquipCurva") Then
        cmdSQL.CommandText = "DROP TABLE TmpEquipCurva"
        cmdSQL.Execute()
      End If
    ...
    straux = "CREATE TABLE TmpEquipCurva (intEquipId INTEGER NOT NULL, intConjCurvaId INTEGER NOT NULL)"
    cmdSQL.CommandText = straux
    cmdSQL.Execute()
    
    straux = "ALTER TABLE TmpEquipCurva ADD PRIMARY KEY (intEquipId)"
    cmdSQL.CommandText = straux
    cmdSQL.Execute()
