...
{
	return (new TBDeqptoAccess410(apl_owner, bd_conn));
}

// ---------------------------------------------------------------------------
__fastcall TBDeqptoAccess410::TBDeqptoAccess410(VTApl *apl_owner, VTSNPDBConn *bd_conn)
...
// ---------------------------------------------------------------------------
__fastcall TBDeqptoAccess410::~TBDeqptoAccess410(void)
{
	// nada a fazer
}

// ---------------------------------------------------------------------------
bool __fastcall TBDeqptoAccess410::SPSNP_rdBateria(VTEstudo* estudo, bool bolUseRedeTmp,
	bool bolObra)
{
	// a tabela nao existe
	return true;
...
// ---------------------------------------------------------------------------
bool __fastcall TBDeqptoAccess410::SPSNP_rdEstudo(void)
{//campo novo justificativa
	bool sucesso = true;
	AnsiString strlog;
	AnsiString strSQL;
...
// ---------------------------------------------------------------------------
bool __fastcall TBDeqptoAccess410::SPSNP_rdEstudoAlternativa(VTEstudo* estudo)
{//igual versao 40
	bool sucesso = true;
	double tipo_padrao;
	AnsiString strlog;
...
// ---------------------------------------------------------------------------
bool __fastcall TBDeqptoAccess410::SPSNP_rdEstudoObraAtribExt(VTEstudo* estudo)
...
// ---------------------------------------------------------------------------
bool __fastcall TBDeqptoAccess410::SPSNP_rdMunicipio(void)
{
	// a tabela nao existe
	return true;
}
...
// ---------------------------------------------------------------------------
bool __fastcall TBDeqptoAccess410::SPSNP_rdRegulador(VTEstudo* estudo, bool bolUseRedeTmp,
	bool bolObra)
{ //tensao inversa igual direta, nao possui campo largura de banda nem relação de tap
	bool sucesso = true;
	AnsiString strlog;
	AnsiString strSQL;
	TADOQuery* ptrQryDS = NULL;
