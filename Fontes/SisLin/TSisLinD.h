...
class TSisLinD : public TSisLin
   ...
   public:
      ...
      bool       __fastcall Back(double termo_conhecido[]);
      bool       __fastcall ColunaInversa(int    ncol,
                                          double vetor[]);
      int        __fastcall ElementoLC(int    linha,
                                       int    coluna,
   ...
   private: // Métodos
      ...
      MatrixElementD * __fastcall CriaElemento(int    linha,
                                               int    coluna,
                                               double valor);
      bool             __fastcall CriaElementosDiagonal(void);
      void             __fastcall DBack(double vector_solution[]);
      void             __fastcall DDefine(bool   flag_insere_simetrico,
                                          int    row,
                                          int    column,
                                          double value,
                                          double zero_virtual=ZERO_VIRTUAL,
                                          TList  *lisREMOVE=NULL);
      void             __fastcall DInsere(bool   flag_insere_simetrico,
                                          int    row,
                                          int    column,
                                          double value,
                                          double zero_virtual=ZERO_VIRTUAL);
      bool             __fastcall DTriang(void);
      MatrixElementD * __fastcall ExisteElementoColuna(int linha,
                                                       int coluna);
      ...
      void             __fastcall OrdenaLinhasMenorUltimaColuna(int   *vet_idro,
                                                                TList *lisELEM_ZERAR);
      void             __fastcall RemoveElementoDaColuna(MatrixElementD *elem);
      void             __fastcall RemoveElementoDaLinha(MatrixElementD *elem);
      void             __fastcall RemoveElementos(double zero_virtual=ZERO_VIRTUAL,
                                                  TList  *lisREMOVE=NULL);

   private: // Dados
      TControleMatrizD *Matriz;
      // Dados usados em QR_Givens()
      struct strAtualiza
         {
         bool           dupla;
         MatrixElementD *elem_col;
         double         valor_lin;
         };
   };
