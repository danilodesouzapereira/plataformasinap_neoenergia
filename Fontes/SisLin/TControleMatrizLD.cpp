...
//---------------------------------------------------------------------------
__fastcall TControleMatrizLD::TControleMatrizLD(int        num_linhas_submatriz,
...
// Aloca e inicializa memória desta classe derivada (TControleMatrizLD)
vet_elem_temp  = NULL;
vet_diag       = new MatrixElementLD * [num_total_linhas];
vet_ultimo_lin = new MatrixElementLD * [num_total_linhas];
vet_ultimo_col = new MatrixElementLD * [num_total_linhas];
ReiniciaVetores();
}

//---------------------------------------------------------------------------
__fastcall TControleMatrizLD::~TControleMatrizLD(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TControleMatrizLD::AlocaMemoriaTriang(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TControleMatrizLD::AlocaMemoriaVetorTemp(void)
{
// Aloca memória para 'vet_elem_temp' e o inicializa, se necessário
if(vet_elem_temp == NULL)
   {
   vet_elem_temp = new MatrixElementLD * [num_total_rows];
...
//---------------------------------------------------------------------------
void __fastcall TControleMatrizLD::ImprimeDadosInternos(AnsiString nome_arquivo,
                                                        int        chave)
{
// Local variables
FILE            *arq;
...
//---------------------------------------------------------------------------
void __fastcall TControleMatrizLD::ImprimeLinha(int        linha,
                                                AnsiString nome_arquivo,
                                                int        chave)
{
FILE            *file_log;
MatrixElementLD *elem1;
...
//---------------------------------------------------------------------------
void __fastcall TControleMatrizLD::ImprimeLinhas(AnsiString nome_arquivo)
{
// Variáveis locais
int             nelem;
FILE            *arq;
MatrixElementLD *elem, **vet_elem;
...
vet_elem = new MatrixElementLD * [num_total_rows];

// Imprime elementos da matriz
fprintf(arq, "\n\n *** Elementos da matriz ***"
             "\n\n   Linha     Coluna           Valor         Núm.elem.FD");
...
//---------------------------------------------------------------------------
void __fastcall TControleMatrizLD::ImprimeLinhasSemDiagonal(AnsiString nome_arquivo)
{
// Variáveis locais
int  kprint, row;
FILE *file_log;
...
//---------------------------------------------------------------------------
void __fastcall TControleMatrizLD::ImprimeTabelaFatores(AnsiString nome_arquivo)
{
// Variáveis locais
int             coluna, nelem;
FILE            *arq;
...
//---------------------------------------------------------------------------
bool __fastcall TControleMatrizLD::ImprimeVetorLongDouble(AnsiString  nome,
                                                          int         count,
                                                          long double *vetor)
{
// Variáveis locais
...
//---------------------------------------------------------------------------
void __fastcall TControleMatrizLD::OrdenaElementos(int             criterio,
                                                   int             nelem,
...
//---------------------------------------------------------------------------
void __fastcall TControleMatrizLD::PermutaVetor(int         num_elems,
                                                long double vetor[])
{
// Variáveis locais
int         indice;
long double *vet_temp;

// Aloca memória para vetor temporário
vet_temp = new long double [num_elems];
...
//---------------------------------------------------------------------------
void __fastcall TControleMatrizLD::ReiniciaLD(void)
{
...
//---------------------------------------------------------------------------
void __fastcall TControleMatrizLD::ReiniciaVetores(void)
{
for(int n=0; n < num_total_rows; n++)
   {
...
//---------------------------------------------------------------------------
bool __fastcall TControleMatrizLD::SeparaLinhas(void)
{
// Variáveis locais
int ord1, ord2;
