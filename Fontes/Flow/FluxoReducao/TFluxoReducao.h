...
class TFluxoReducao : public VTFluxoReducao
   ...
   private: //métodos
      ...
      void __fastcall SomaFluxoEqbarReducao(TList *lisEQP, VTBarra *pbarra, int np, complex<double> stot_mva[MAX_FASE]);
      void __fastcall SomaFluxoLigacao(TList *lisLIG, VTBarra *pbarra, int np, complex<double> stot_mva[MAX_FASE]);
