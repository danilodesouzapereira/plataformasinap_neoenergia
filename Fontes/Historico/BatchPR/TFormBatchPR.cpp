...
// ---------------------------------------------------------------------------
__fastcall TFormBatchPR::TFormBatchPR(TComponent* Owner, VTApl *apl_owner) : TForm(Owner)
{
	// variáveis locais
	...
	apl->Add(batch_pr = NewObjBatchPR(apl));
...
// ---------------------------------------------------------------------------
__fastcall TFormBatchPR::~TFormBatchPR(void)
{
	// variáveis locais
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::ActionCfgPerdaExecute(TObject *Sender)
{
	// variáveis locais
	TForm *Form;
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::ActionCriaBaseHistoricoExecute(TObject *Sender)
{
	// esconde este Form  p/ não esconde janela de seleção do arquivo
	Visible = false;
	// cria base
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::ActionExecutarExecute(TObject *Sender)
{
	// variáveis locais
	AnsiString msg;
	...
	batch_pr->DataIni = DateOf(DateTimePickerIni->Date);
	batch_pr->DataFim = DateOf(DateTimePickerFim->Date);
	batch_pr->LBoxLogRede = LBoxLogRede;
	batch_pr->LBoxLogPasso = LBoxLogPasso;
	if (batch_pr->Executa())
...
// ---------------------------------------------------------------------------
bool __fastcall TFormBatchPR::UsuarioConfigurouPerdas(void)
{
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::ActionFechaExecute(TObject *Sender)
{
	// fecha o Form
	Close();
}
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::ActionHelpExecute(TObject *Sender)
{
	// variaveis locais
	TForm *formHelp;
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::ActionSelBaseHistoricoExecute(TObject *Sender)
{
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::CheckBoxAjusteDemandaClick(TObject *Sender)
{
...
/*
 //---------------------------------------------------------------------------
 void __fastcall TFormBatchPR::CriaBaseAccessHistorico(void)
 {
 //variaveis locais
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::DateTimePickerFimChange(TObject *Sender)
{
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::DateTimePickerIniChange(TObject *Sender)
{
...
// ---------------------------------------------------------------------------
bool __fastcall TFormBatchPR::ExisteArvoreNaBase(int tipo, TDateTime data_ini, TDateTime data_fim)
{
	// varia´veis locais
	bool existe = false;
	int num_meses;
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::FormIniciaPosicao(void)
{
	// variáveis locais
	VTGeral *geral = (VTGeral*)apl->GetObject(__classid(VTGeral));
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::IniciaArquivos(void)
{
	// variáveis locais
	int num_meses;
	AnsiString txt;
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::PageControlChange(TObject *Sender)
{
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::PageControlChanging(TObject *Sender, bool &AllowChange)
{
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::RadioGroupTopologiaClick(TObject *Sender)
{
...
// ---------------------------------------------------------------------------
void __fastcall TFormBatchPR::ReiniciaArquivos(void)
{
...
/*
 //---------------------------------------------------------------------------
 void  __fastcall TFormBatchPR::SelecionaBaseHistorico(void)
 {
 //variáveis locais
 VTPath *path  = (VTPath*)apl->GetObject(__classid(VTPath));
...
// ---------------------------------------------------------------------------
bool __fastcall TFormBatchPR::ValidaArquivosSelecionados(void)
{
	// variáveis locais
...
// ---------------------------------------------------------------------------
bool __fastcall TFormBatchPR::ValidaDatasSelecionadas(void)
{
...
// ---------------------------------------------------------------------------
bool __fastcall TFormBatchPR::ValidaLicenca(void)
{
	// variáveis locais
...
// ---------------------------------------------------------------------------
bool __fastcall TFormBatchPR::VerificaOpcoes(void)
{
