//---------------------------------------------------------------------------
#ifndef TFormBatchPTH
#define TFormBatchPTH
...
//---------------------------------------------------------------------------
class TFormBatchPT : public TForm
{
...
public:		// User declarations
   __fastcall  TFormBatchPT(TComponent* Owner, VTApl *apl_owner);
   __fastcall ~TFormBatchPT(void);
