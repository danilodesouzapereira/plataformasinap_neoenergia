//---------------------------------------------------------------------------
#ifndef TFormReclamacaoMTH
#define TFormReclamacaoMTH
//---------------------------------------------------------------------------
...
class VTSuprimento;
//---------------------------------------------------------------------------
class TFormReclamacaoMT : public TFormEdt
{
...
public:      // User declarations
   __fastcall  TFormReclamacaoMT(TComponent *Owner, VTApl *apl_owner, TWinControl *parent);
   __fastcall ~TFormReclamacaoMT(void);

public:
   bool inicializado;

private:   //métodos
   VTBarra*       __fastcall BarraInicialRedePri(void);
...
//---------------------------------------------------------------------------
extern PACKAGE TFormReclamacaoMT *FormReclamacaoMT;
//---------------------------------------------------------------------------
#endif
