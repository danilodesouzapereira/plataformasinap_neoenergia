...
//   limite[8] = 5;
//	limite[0] = 0;
//	limite[1] = 0.8 * geral->FLOW.V[redePRI][0];
//	limite[2] = geral->FLOW.V[redePRI][0];
//	limite[3] = (geral->FLOW.V[redePRI][0] + geral->FLOW.V[redePRI][1]) / 2.;  //inverti com o proximo
//	limite[4] = geral->FLOW.V[redePRI][1];
//	limite[5] = geral->FLOW.V[redePRI][2];
//	limite[6] = geral->FLOW.V[redePRI][3];
//	limite[7] = 1.2 * geral->FLOW.V[redePRI][3];
//	limite[8] = 5;
	padraoRede = geral->ExistePadraoRede(redePRI);
	limite[0] = 0;
	limite[1] = 0.8 * padraoRede->V1;
	limite[2] = padraoRede->V1;
	limite[3] = (padraoRede->V1 + padraoRede->V2) / 2.;  //inverti com o proximo
	limite[4] = padraoRede->V2;
	limite[5] = padraoRede->V3;
	limite[6] = padraoRede->V4;
	limite[7] = 1.2 * padraoRede->V4;
	limite[8] = 5;
	//cores das faixas             aqueles
	color[0] = clWhite;
	color[1] = cfg_cor->TENSAO.corV1;
