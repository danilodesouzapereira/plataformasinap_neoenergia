...
void __fastcall TFormViewFase::IniciaVetorFases(void)
   {
   //variáveis locais
   int     tag[DIM_VET_FASE] = {faseA,   faseB,  faseC,   faseAB,
                                faseBC,  faseCA, faseABC, faseAN,
                                faseBN,  faseCN, faseABN, faseBCN,
                                faseCAN, faseABCN, -1};
   TColor  cor[DIM_VET_FASE] = {clBlue,    clGreen,     clRed,          clTeal,
                                clFuchsia, clYellow,    clWebMistyRose, clSkyBlue,
                                clLime,    clMaroon,    clNavy,         clPurple,
                                clOlive,   clWebOrange, clGray};
...
int __fastcall TFormViewFase::MapeiaFaseNoVetFase(int fases)
   ...
   switch(fases & faseABCN)
      ...
      case faseAN:   return(7);
      case faseBN:   return(8);
      case faseCN:   return(9);
      case faseABN:  return(10);
      case faseBCN:  return(11);
      case faseCAN:  return(12);
      case faseABCN: return(13);
