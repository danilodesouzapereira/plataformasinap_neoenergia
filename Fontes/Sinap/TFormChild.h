...
__published:
   ...
   void __fastcall ActionSelRedeExecute(TObject *Sender);
	void __fastcall ActionSalvarBaseConvertidaExecute(TObject *Sender);
...
public:
   ...
   void   __fastcall  InsereMsgAlerta(AnsiString txt, VTRede *rede = NULL);
   void   __fastcall  Reinicia(bool starting=true);

public:   //property
   __property VTApl* Apl = {read=apl};
...
private: //métodos
   ...
   bool         __fastcall FechaFormPerda(void);
   ...
   void         __fastcall SalvaAnoEstudo(VTEstudo *estudo, bool confirma);
   ...
   bool         __fastcall SalvaRedeComo(bool permite_nome_igual = true);
   ...
   bool         __fastcall TrocaRedeEqvBTporCargaEqv(VTApl* apl);
   int          __fastcall ValidaEqptoIsolado(void);
