...
class TMatrizC : public TMatriz
   ...
   public:
      ...
      bool            __fastcall Back(complex<double> *vet_TC);
      ...
      complex<double> __fastcall ProdutoVV(complex<double> *vet_ent);
      complex<double> __fastcall ProdutoVVC(VTMatriz *vet_ent);

      // Métodos com argumentos double (implementação nula)
      bool            __fastcall Back(double *vet_TC) {return(true);};
      ...
      bool            __fastcall ProdutoMV(double *vet_ent,
                                           double *vet_sai) {return(true);};
      double          __fastcall ProdutoVV(double *vet_ent) {return(0.);};
      double          __fastcall ProdutoVVD(VTMatriz *vet_ent) {return(0.);};
   ...
   private: // Dados
      ...
      complex<double> *vet_dados;

   private:  // Métodos com dados complex<double>
      complex<double> __fastcall PM_GetC1(int i);
      complex<double> __fastcall PM_GetC2(int i, int j);
      complex<double> __fastcall PM_GetC3(int i, int j, int k);
   ...
   private:  // Métodos com dados double (implementação nula)
      double          __fastcall PM_GetD1(int i) {return(0.);};
      double          __fastcall PM_GetD2(int i, int j) {return(0.);};
      double          __fastcall PM_GetD3(int i, int j, int k) {return(0.);};
