...
class TMatrizI : public TMatriz
   ...
   public:
      ...
      bool            __fastcall Back(int *vet_TC);
      ...
      bool            __fastcall ProdutoMV(int *vet_ent,
                                           int *vet_sai);
      int             __fastcall ProdutoVV(int *vet_ent);
      int             __fastcall ProdutoVVI(VTMatriz *vet_ent);
   ...
   private:  // Métodos com dados int
      int             __fastcall PM_GetI1(int i);
      int             __fastcall PM_GetI2(int i, int j);
      int             __fastcall PM_GetI3(int i, int j, int k);
   ...
   private:  // Métodos locais
      ...
      bool            __fastcall CopiaElementosD(VTMatriz *mat_dest);
