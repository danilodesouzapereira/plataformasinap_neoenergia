...
//---------------------------------------------------------------------------
__fastcall TFormImportaTXT::TFormImportaTXT(TComponent* Owner, VTApl *apl_owner)
   : TForm(Owner)
   {
	//variáveis locais
...
//---------------------------------------------------------------------------
__fastcall TFormImportaTXT::~TFormImportaTXT(void)
   {
   //variáveis locais
...
//---------------------------------------------------------------------------
void __fastcall TFormImportaTXT::ActionCancelaSelecaoExecute(TObject *Sender)
   {
...
//---------------------------------------------------------------------------
void __fastcall TFormImportaTXT::ActionImportaExecute(TObject *Sender)
   {
   //variáveis locais
   bool        sucesso;
...
//---------------------------------------------------------------------------
void __fastcall TFormImportaTXT::ActionFechaExecute(TObject *Sender)
   {
   //fecha form
   ModalResult = mrOk;
   }
...
//---------------------------------------------------------------------------
void __fastcall TFormImportaTXT::ActionReiniciarRedeExecute(TObject *Sender)
   {
   //var local
...
//---------------------------------------------------------------------------
void __fastcall TFormImportaTXT::ActionRetArquivoExecute(TObject *Sender)
   {
   //proteção
...
//---------------------------------------------------------------------------
void __fastcall TFormImportaTXT::ActionSelArquivoTxtExecute(TObject *Sender)
   {
...
//---------------------------------------------------------------------------
void __fastcall TFormImportaTXT::FormClose(TObject *Sender, TCloseAction &Action)
   {
   //esconde o Form
   Action = caHide;
   }
...
//---------------------------------------------------------------------------
void __fastcall TFormImportaTXT::FormIniciaPosicao(void)
   {
   //variáveis locais
   VTGeral *geral = (VTGeral*)apl->GetObject(__classid(VTGeral));
...
//---------------------------------------------------------------------------
void __fastcall TFormImportaTXT::FormShow(TObject *Sender)
   {
   //posiciona o Form
   FormIniciaPosicao();
   }
...
//---------------------------------------------------------------------------
bool __fastcall TFormImportaTXT::ImportaRede(void)
   {
   strOPImporta opcao;
   bool         resp;
   ...
   opcao.gerarTXT           = CheckBoxArqTXT->Checked;//false; //DVK 2013.08.01
   //opções de ihm
   opcao.ihm.log            = CheckBoxLog->Checked;
   switch(RadioGroupProgresso->ItemIndex)
      {
      case 0:  opcao.ihm.progresso = progNENHUM;  break;
      case 1:  opcao.ihm.progresso = progDEFAULT; break;
      case 2:  opcao.ihm.progresso = progTEXTO;   break;
      default: opcao.ihm.progresso = progDEFAULT; break;
      }
...
*/
//---------------------------------------------------------------------------
void __fastcall TFormImportaTXT::LBoxArquivoInicia(int num_colunas)
   {
   //reinicia LBoxArquivo
   LBoxArquivo->Clear();
...
//---------------------------------------------------------------------------
void __fastcall TFormImportaTXT::LBoxArquivoKeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
   {
...
*/
//---------------------------------------------------------------------------
int __fastcall TFormImportaTXT::LeArquivos(void)
   {
   return(StrListAllFiles->Count);
   }

//---------------------------------------------------------------------------
bool __fastcall TFormImportaTXT::ReiniciaRede(bool aviso)
   {
   //var local
...
/*
//---------------------------------------------------------------------------
void  __fastcall TFormImportaTXT::SelecionaArquivos(void)
   {
   //variáveis locais
...
*/
//---------------------------------------------------------------------------
void  __fastcall TFormImportaTXT::SelecionaArqTxt(TStrings *files)
   {
   //variáveis locais
...
//---------------------------------------------------------------------------
void  __fastcall TFormImportaTXT::SelecionaLisArqTxt(TStrings *files)
   {
   //variáveis locais
   AnsiString filename, extensao;
