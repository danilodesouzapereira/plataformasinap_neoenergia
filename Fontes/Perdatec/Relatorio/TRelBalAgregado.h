...
#ifndef TRelBalAgregadoH
#define TRelBalAgregadoH
...
class TRelBalAgregado : public TObject
   {
   public:
			   __fastcall TRelBalAgregado(VTApl *apl);
			   __fastcall ~TRelBalAgregado(void);
	  bool     __fastcall AgregaResumo(VTResumo *resumo);
