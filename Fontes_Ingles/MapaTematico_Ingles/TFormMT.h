...
__published:   // IDE-managed Components
   ...
   TActionList *ActionListCellPlan;
   TAction *ActionCelPlanner;
   TAction *ActionCellPlannerExporta;
   ...
   void __fastcall ActionCelPlannerExecute(TObject *Sender);
   void __fastcall ActionCellPlannerExportaExecute(TObject *Sender);
